...
const value: components.WebhookPayloadTrack = {
  data: {
    ...
    trackingHistory: [
      {
        ...
        objectCreated: new Date("2022-07-16T20:17:42.484Z"),
        objectId: "<id>",
        objectUpdated: new Date("2022-01-28T01:08:57.377Z"),
        status: "DELIVERED",
        substatus: {
    ...
    trackingStatus: {
      ...
      objectCreated: new Date("2022-03-15T16:56:03.501Z"),
      objectId: "<id>",
      objectUpdated: new Date("2024-01-15T14:44:51.051Z"),
      status: "DELIVERED",
      substatus: {
        code: "information_received",
        text: "Information about the package received.",
