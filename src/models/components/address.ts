...
import {
  ...
  AddressValidationResults$outboundSchema,
...
/** @internal */
export const Latitude$inboundSchema: z.ZodType<
  Latitude,
  z.ZodTypeDef,
  unknown
...
/** @internal */
export const Latitude$outboundSchema: z.ZodType<
  Latitude$Outbound,
  z.ZodTypeDef,
  Latitude
> = z.union([z.number(), z.string()]);
...
export namespace Latitude$ {
  ...
  export const inboundSchema = Latitude$inboundSchema;
  /** @deprecated use `Latitude$outboundSchema` instead. */
  export const outboundSchema = Latitude$outboundSchema;
...
/** @internal */
export const Longitude$outboundSchema: z.ZodType<
  Longitude$Outbound,
  z.ZodTypeDef,
  Longitude
> = z.union([z.number(), z.string()]);
...
export namespace Longitude$ {
  ...
  export const inboundSchema = Longitude$inboundSchema;
